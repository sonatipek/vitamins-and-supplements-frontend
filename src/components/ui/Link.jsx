    ...
    return (
      <a
        ...
        className={`inline-flex justify-center items-center group ${
          type === "button"
            ? "bg-brand border border-brand hover:bg-transparent hover:text-darkest hover:dark:text-white transition-colors duration-300 px-14 py-2.5 rounded-full flex items-center justify-center text-white font-medium shadow-lg"
